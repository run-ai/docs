...
\| canAdd | Whether the submission request can add items to an itemized field other than those listed in the policy defaults for this field. | [itemized](policy-yaml-reference.md#value-types) |
