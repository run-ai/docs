...
3. The user is logged in (use the [runai login](../../saas/cli-reference/new-cli/guides/broken-reference/) command).
...
Add the following to the Kubernetes client configuration file (./kube/config). For the full command reference, see [kubeconfig set](../../saas/cli-reference/new-cli/guides/broken-reference/).
