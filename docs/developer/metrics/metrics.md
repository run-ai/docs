...
| runai_gpu_is_allocated                         |  {gpu, clusterId, node}                                               |    0 or 1   | Is a GPU hosting a pod                                                                                                                                                                    |
| runai_gpu_is_running_fractional_job            |  {gpu, clusterId, node}                                               |    0 or 1   | Is GPU hosting Fractional GPU jobs?                                                                                                                                                       |
| runai_gpu_last_active_time                     |  {gpu, clusterId, node}                                               | __xx__      | Last time GPU was not idle                                                                                                                                                                       |
...
| runai_job_image                                |  {image, job_uuid, job_name, clusterId}                               |  __N/A__    | Image name per job                                                                                                                                                                               |
...
| runai_job_status_with_info                     |  {user, job_type, status, job_name, clusterId, node, project}         |  __N/A__    | Information on jobs including user name, job type, runai status (phase), K8s status (detailed_status), project name (queue_name), and node name, Current jobs status (phase) receives Value=1 |
...
| runai_project_info                             |  {memory_quota, cpu_quota, gpu_guaranteed_quota, clusterId, project}  | __N/A__     | Information on CPU, CPU Memory, GPU quota per project                                                                                                                       |
