...
| runai_run_time_seconds_per_workload             |  {clusterId, job_uuid}                                                                        | Seconds     | Total run time per workload                                                                                                  |
| runai_wait_time_seconds_per_workload            |  {clusterId, job_uuid}                                                                        | Seconds     | Total wait time per workload                                                                                                 |
