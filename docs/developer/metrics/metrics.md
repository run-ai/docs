...
!!! Warning
    From cluster version 2.17 and onwards, Run:ai supports metrics via the [Run:ai Control-plane API](../admin-rest-api/overview.md). Direct metrics queries (metrics that are queried directly from Prometheus) are deprecated.
