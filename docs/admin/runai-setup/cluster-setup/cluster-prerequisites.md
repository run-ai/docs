...
=== "Oracle Kubernetes Engine (OKE)"
    ...
    helm install nginx-ingress ingress-nginx/ingress-nginx \
        ...
        --set controller.service.annotations.oci-network-load-balancer\\.oraclecloud\\.com/subnet=<SUBNET-ID> # Replace <SUBNET-ID> with the subnet ID of one of your control plane 
    ```
