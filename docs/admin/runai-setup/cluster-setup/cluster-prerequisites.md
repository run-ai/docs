...
Run:ai has been certified on **NVIDIA GPU Operator**  22.9 to 24.6. Older versions (1.10 and 1.11) have a documented [NVIDIA issue](https://github.com/NVIDIA/gpu-feature-discovery/issues/26){target=_blank}.
