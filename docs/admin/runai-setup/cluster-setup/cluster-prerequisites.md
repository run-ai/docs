...
| RKE | Rancher Kubernetes Engine          | When installing Run:ai, select _On Premise_. You must perform the mandatory extra step [here](../../troubleshooting/troubleshooting.md#kubernetes-specific-issues). __Important Note__ Run:ai does not currently support RKE2. |
