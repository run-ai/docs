...
| `global.nodeAffinity.restrictRunaiSystem` | false | Restrict scheduling of Run:ai system pods to Run:ai designated nodes For more information see [System workers](https://docs.run.ai/latest/admin/runai-setup/self-hosted/k8s/preparations/#mark-runai-system-workers-optional)) |
