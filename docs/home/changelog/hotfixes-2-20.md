...
|--|--|--|--|
| 2.20.59 | 14/07/2025 | RUN-28189 | Fixed an issue where the CLI cache folder was created in a location where the user might not have sufficient permissions, leading to failures. The cache folder is now created in the same directory as the config file. |
