...
|--|--|--|--|
| 2.20.33 | 01/04/2025 | RUN-26955 | Fixed an issue where duplicate results appeared in some cases for node metrics. |
...
| 2.20.28 | 17/03/2025 | RUN-26688 | Fixed an issue where node pools could get stuck in the Updating state. |
