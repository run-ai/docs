...
| :---- | :---- | :---- |
| RUN-26359 | 2.18.102 | Fixed an issue in CLI v2 where using the --toleration option required incorrect mandatory fields. The required fields are now properly validated. |
