...
* <!-- RUN-11692/RUN-11694 Scoping for template-->Added support for Run:ai a *Scope* in the template form. For configuration information, see [Creating templates](../platform-admin/workloads/assets/templates.md#creating-templates).
