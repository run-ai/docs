...
Added support for custom logos in SaaS, and self-hosted environments using the Admin API. For more information, see [Upload tenant logo](https://app.run.ai/api/docs#tag/Tenant/operation/upload_tenant_logo){target=_blank}.
