...
#### --workload string
>  Provide the name of a template, from which default values are to be taken. 
...
Note that the submit call may use defaults from pre-loaded policies to any of the above flags.
