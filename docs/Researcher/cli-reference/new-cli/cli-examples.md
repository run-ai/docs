...
### Requests and limits
```shell
runai workspace submit  -p alon -i gcr.io/run-ai-demo/quickstart-demo   --cpu-core-request 0.3 --cpu-core-limit 1 --cpu-memory-request 50M --cpu-memory-limit 1G  --gpu-devices-request 1 --gpu-memory-request 1G
```
