...
```
runai workspace submit --name=<workspace_name> --project=<project_name> -i=gcr.io/run-ai-demo/quickstart
```
...
```
      ...
      --annotations stringArray                        Set of annotations to populate into the container running the workspace
  ...
  -e, --environment stringArray                        Set environment variables in the container
      ...
      --extended-resources stringArray                 Request access to an extended resource. Use the format: resource_name=quantity
  ...
  -g, --gpu-devices-request int32                      GPU units to allocate for the job (e.g. 1, 2)
      ...
      --gpu-request-type string                        GPU request type (portion|memory|mig)
  ...
  -i, --image string                                   The image for the workload
      ...
      --labels stringArray                             Set of labels to populate into the container running the workspace
      --large-shm-request                              Request large /dev/shm device to mount
      ...
      --node-pool stringArray                          List of node pools to use for scheduling the job, ordered by priority
      ...
      --prefix                                         Set defined prefix for the job name
