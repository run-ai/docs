...
```
runai distributed submit [flags]
```

### Examples

```
runai distributed submit <distributed_name> -p=<project_name> -i=runai.jfrog.io/artifactory/demo/quickstart -f XGBoost/PyTorch/TF/MPI
```
