...
The [runai submit](../cli-reference/runai-submit.md) function and its sibling the [runai submit-dist mpi](../cli-reference/runai-submit-dist-mpi.md) function submit Run:ai Jobs for execution.
