...
To do so, we recommend using the [environment variables](../best-practices/env-variables.md) `JOB_NAME` and `JOB_UUID` which are injected to the container by Run:ai.
